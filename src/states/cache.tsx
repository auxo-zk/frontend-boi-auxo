...
const cacheContractFile = [
    ...
    { name: 'step-vk-nullifiercontract-commit', type: 'string' },
    { name: 'step-vk-nullifiercontract-rollup', type: 'string' },
    ...
    { name: 'step-vk-rollupnullifier-commit', type: 'string' },
    { name: 'step-vk-rollupnullifier-firststep', type: 'string' },
    ...
    { name: 'wrap-vk-nullifiercontract', type: 'string' },
    ...
    { name: 'wrap-vk-rollupnullifier', type: 'string' },
