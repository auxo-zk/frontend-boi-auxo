...
const cacheContractFile = [
    ...
    // { name: 'step-vk-claim-fund-createtreasury', type: 'string' },
    { name: 'step-vk-claim-fund-firststep', type: 'string' },
    { name: 'step-vk-claim-fund-nextstep', type: 'string' },
    ...
    { name: 'step-vk-treasurycontract-checkifnotclaimed', type: 'string' },
    { name: 'step-vk-treasurycontract-claimfund', type: 'string' },
    { name: 'step-vk-treasurycontract-rollup', type: 'string' },
    { name: 'wrap-vk-claim-fund', type: 'string' },
    ...
    { name: 'wrap-vk-treasurycontract', type: 'string' },
];
